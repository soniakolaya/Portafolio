...
Resultado de un proyecto desarrollado para diseñar un ELT que permitiria estructurar el modelo de datos para la información de una EPS. Desarrollado con fines academicos.
...
Resultado del desarrollo de un proyecto que buscaba a partir del Estudio de Medición de Pobreza Monetaria y Desigualdad (DANE,2023), construir una segmentacion de hogares basado en modelos de aprendizaje no supervisado.
